<!-- /////////////////////////////////////////////////////////////////////////////////////
M2M 멘토멘티 찾기 게시판 로직(멘티 게시판 에서 글 쓰기)
///////////////////////////////////////////////////////////////////////////////////////////-->
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">멘티에게 방명록 남기기</a>
        </div>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <form class="form-horizontal" method=POST action=menti_find_write_ok.php>                      
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="user" class="form-control" id="inputEmail3" value="<?=$_SESSION['username'];?>">
            </div>
          </div>
          <div class="form-group">
